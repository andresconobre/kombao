                    ...
                    <RouterLink :to="`/membros/${lowername}`">
                        <swiper :slides-per-view="1" class="rounded-md group border-2 border-black relative hover:scale-105 duration-200">
                            ...
                            <swiper-slide v-for="foto in fotos" :key="foto">
                                <img :src="`/img/${lowername}/${lowername}${foto}.png`" :alt="nome" class="object-cover aspect-[3/4] h-full w-full transition-transform duration-300 ease-in-out group-hover:-translate-y-10 z-10 relative hover:cursor-grab">
                            </swiper-slide>
